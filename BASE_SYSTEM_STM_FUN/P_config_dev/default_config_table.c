...
*/
	...
	ps_mem_data_set->s_config_moduls.s_mesurement_user_config.a_r[0]=0;
	ps_mem_data_set->s_config_moduls.s_mesurement_user_config.a_r[1]=0;
	ps_mem_data_set->s_config_moduls.s_mesurement_user_config.a_r[2]=0;
