...
//Нижний порог на запись результатов измерений тока, мА
#define CURRENTTHRESHOLD_DOWN  40
//Верхний порог авврийного состояния, мА
#define CURRENTTHRESHOLD_UP    6000
